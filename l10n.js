export default {
    "en": {
        ...
        // tello
        'cxtello.actionMenu.command': 'command',
        'cxtello.actionMenu.takeoff': 'takeoff',
        'cxtello.actionMenu.land': 'land',
        'cxtello.actionMenu.streamon': 'streamon',
        'cxtello.actionMenu.streamoff': 'streamoff',
        'cxtello.actionMenu.emergency': 'emergency',
        'cxtello.actionMenu.up': 'up',
        'cxtello.actionMenu.cw': 'cw',
        'cxtello.actionMenu.direction': 'direction',
        'cxtello.actionMenu.go': 'go',
        'cxtello.actionMenu.setspeed':'set speed [SPEED]',
        'cxtello.actionMenu.setwifi': 'set wifi:[WIFI] pass:[PASS]',
        'cxtello.actionMenu.setrc': 'set 横滚:[A] 俯仰:[B] 油门:[C] 旋转:[D]',

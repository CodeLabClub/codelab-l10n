const json = {
  en: {
    ...
    // leap montion
    "leapMotion.handPositon": "hand [Hand] coordinate [Coordinate]",
    "leapMotion.handRotation": "hand [Hand] rotation",
    "leapMotion.handFingerdipPosition":
      "hand [Hand] finger [Finger] coordinate [Coordinate]",

    // HomeAssistant
    "cxhomeassistant.connect_to_hass":
      "Connect To Home Assistant at [hass_uri]",
    ...
    "cxhomeassistant.turn_light_or_switch_plug":
      "Turn [Light_or_Switch] [light_switch_id] [on_off]",
    "cxhomeassistant.setLightColorToColor":
      "set light(s) [light_id] color to [COLOR]",
    "cxhomeassistant.setLightBrightness":
      "set light [light_id] brightness to [brightness]",
    "cxhomeassistant.setLightEffect": "set light [light_id] Effect to [effect]",
    "cxhomeassistant.controlTheDoor": "[operate] the door",
    "cxhomeassistant.controlTheCurtain":
      "[operate_curtain] [curtain_id] curtain",
    "cxhomeassistant.setCoverPosition":
      "set cover [curtain_id] position:[position]",
    "cxhomeassistant.whenbuttonispressed":
      "When Click Switch [click_switch_id] [click_mode]",
    "cxhomeassistant.whenmotionsensorstatechange": "When somebody [left_came]",
    "cxhomeassistant.whendoorwindowsensorstatechange":
      "When Door/Window [open_close]",
  ...
  "zh-cn": {
    ...
    "cxhomeassistant.turn_light_or_switch_plug":
      "将[Light_or_Switch][light_switch_id]设为[on_off]",
    ...
    "cxhomeassistant.whenbuttonispressed":
      "当开关[click_switch_id] [click_mode]",
    ...
    //blender
    "blender.whenMessageReceive": "当接收到 [content]",
    "blender.getComingMessage": "收到的消息",
    "blender.sendMessage": "执行[content]",
    "blender.exec_and_get_result": "执行[content]并等待",
  
    // leap montion
    "leapMotion.handPositon": "手 [Hand] 位置 [Coordinate]",
    "leapMotion.handRotation": "手 [Hand] 旋转",
    "leapMotion.handFingerdipPosition":
      "手 [Hand] 手指 [Finger] 位置 [Coordinate]",
